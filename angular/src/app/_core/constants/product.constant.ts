export const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      'Celana jeans slim fit yang modis dan fleksibel, cocok untuk berbagai aktivitas.',
    originalPrice: 80000,
    discount: 25,
  },
  {
    ...
    name: 'Kaos Polo Biru',
    description:
      'Kaos polo biru dengan kerah yang rapi dan bahan yang mudah menyerap keringat.',
    originalPrice: 60000,
    discount: 5,
  },
  {
  ...
  },
  {
    ...
    description:
      'Rok mini dengan motif bunga yang ceria, cocok untuk tampilan santai dan feminin.',
    originalPrice: 55000,
    discount: 20,
  },
  {
    ...
    description:
      'Sweater rajut hijau yang hangat dan stylish, cocok untuk musim dingin.',
    originalPrice: 85000,
    discount: 10,
  },
  {
    ...
    description:
      'Celana pendek cargo dengan banyak kantong, ideal untuk aktivitas outdoor.',
    originalPrice: 40000,
    discount: 0,
  },
  {
    ...
    description:
      'Dress polkadot merah dengan model fit and flare, cocok untuk acara semi-formal.',
    originalPrice: 90000,
    discount: 35,
  },
  {
    ...
    description:
      'Jaket denim oversize yang trendi, cocok untuk tampilan casual dan streetwear.',
